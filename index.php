                                ...
                                <div class="gform_body gform-body">
                                    <div id="gform_fields_75"
                                        ...
                                        <div id="field_75_1"
                                            ...
                                            <p>Hôm nay, ngày <?php echo date('d/m/Y'); ?>, tại văn phòng Công ty TNHH
                                        ...
                                        <div id="field_75_3"
                                            ...
                                            <div class="ginput_container ginput_container_text">
                                                <input name="input_3" id="input_75_3" type="text" value="" class="large"
                                        ...
                                        <div id="field_75_5"
                                            ...
                                            <div class="ginput_container ginput_container_text">
                                                <input name="input_5" id="input_75_5" type="text" value="" class="large"
                                        ...
                                        <div id="field_75_4"
                                            ...
                                            <div class="ginput_container ginput_container_text">
                                                <input name="input_4" id="input_75_4" type="text" value="" class="large"
                                        ...
                                        <div id="field_75_6"
                                            ...
                                            <div class="ginput_container ginput_container_text">
                                                <input name="input_6" id="input_75_6" type="text" value="" class="large"
                                        ...
                                        <div id="field_75_7"
                                            ...
                                            <div class="ginput_container ginput_container_text">
                                                <input name="input_7" id="input_75_7" type="text" value="" class="large"
                                        ...
                                        <div id="field_75_9"
                                            ...
                                            <div class="ginput_container ginput_container_text">
                                                <input name="input_9" id="input_75_9" type="text" value="" class="large"
                                        ...
                                        <div id="field_75_8"
                                            ...
                                            <div class="ginput_container ginput_container_text">
                                                <input name="input_8" id="input_75_8" type="text" value="" class="large"
                                                ...
                                                <div class="gfield_radio" id="input_75_41"
                                                    ...
                                                    <div class="gchoice gchoice_75_41_0">
                                                        <input class="gfield-choice-input" name="input_41" type="radio"
                                                               value="1" checked id="choice_75_41_0">
                                                ...
                                                <div class="gfield_radio" id="input_75_40">
                                                    <div class="gchoice gchoice_75_40_0">
                                                        <input class="gfield-choice-input" name="input_40" type="radio"
                                                               value="1" id="choice_75_40_0" checked>
                                        ...
                                        <div id="field_75_27"
                                            ...
                                            <label class="gfield_label" style="text-align:center;display:block">BÊN B
                                                <br>GIÁM ĐỐC</label>
                                        ...
                                        <div id="field_75_2"
                                            ...
                                            <label class="gfield_label" for="input_75_2">BÊN A (HỌC VIÊN)<span
                                                        class="gfield_required"><span
                                                            class="gfield_required gfield_required_asterisk">*</span></span></label>
                                            <div class="gfield_description" id="gfield_description_75_2">Ký tên (không
                                                cần ghi họ tên)
                                            </div>
                                            <div>
                                                <div id="input_75_2_Container"
                                                     class="gfield_signature_container ginput_container"
                                                     style="position:relative;height: 180px; width: 400px; z-index: 99;">
                                                    <input type="hidden" class="gform_hidden" name="input_75_2_valid"
                                                           id="input_75_2_valid">
                                                    <div id="input_75_2" class='js-signature' data-width="400"
                                                         data-height="180" data-border="1px solid black"
                                                         data-line-color="#bc0000" data-auto-fit="true" width="400"
                                                         height="180"
                                                         style="border-width: 1px; border-style: dashed; border-color: rgb(0, 84, 165); background-color: rgb(255, 255, 255); cursor: url('https://hikorean.edu.vn/contract/wp-content/plugins/gravityformssignature/includes/super_signature/pen.cur'), pointer; width: 400px; height: 180px;"></div>
                                                    <div id="signature-viewer" width="400" height="180"
                                                         style="display:none;position:absolute;top:0;left:0;right:0;bottom:0;border-width: 1px; border-style: dashed; border-color: rgb(0, 84, 165); background-color: rgb(255, 255, 255); width: 400px; height: 180px;">
                                                        <input type="hidden" name="input-signature"
                                                               id="input-signature"/>
                                                        <img id="img-signature-preview"/>
                                                    </div>
                                                </div>
                                                <div id="input_75_2_toolbar"
                                                     style="margin:5px;position:relative;height:20px;width:400px;background-color:transparent;">
                                                    <img id="input_resetbutton" src="assets/images/refresh.png"
                                                         style="cursor:pointer;float:right;height:24px;width:24px;border:0px solid transparent">
                                                    <div id="input_status"
                                                         style="color: blue; height: 20px;cursor:pointer; width: auto; padding: 2px; font-family: verdana; font-size: 12px; float: left; margin-right: 30px;">
                                                        Save
                                                    </div>
                                                    <input type="hidden" id="input_75_2_data" name="input_75_2_data"
                                                           value=""><input type="hidden" id="input_75_2_data_smooth"
                                                                           name="input_75_2_data_smooth" value=""><input
                                                            type="hidden" id="input_75_2_data_canvas"
                                                            name="input_75_2_data_canvas" value="">
                                                    <button type="button" id="input_75_2_lockedReset"
                                                            class="gform_signature_locked_reset"
                                                            style="display:none;height:24px;cursor:pointer;padding: 0 0 0 1.8em;opacity:0.75;font-size:0.813em;border:0;background: transparent url(data:image/svg+xml;base64,) no-repeat left center;background-size:16px;">
                                                        Reset to re-sign.
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div id="field_75_16"
                                             class="gfield gfield--width-full gf_invisible gfield_html gfield_html_formatted field_sublabel_below field_description_below gfield_visibility_visible">
                                            <p style="text-transform: uppercase"><strong>{Họ và tên:3}</strong></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="gform_footer top_label">
                                    <a id="submit_button" class="gform_button button">XÁC NHẬN VÀ GỬI</a>
                                    <div class="gform_validation_errors" id="gform_validation_container_error"
                                         style="display:none"><h2 class="gform_submission_error hide_summary"
                                                                  id="error_message">Bạn vui lòng điền đầy đủ thông
                                            tin.</h2></div>
                                    <div class="gform_validation_errors" id="gform_validation_container_completed"
                                         style="display:none;border:1.5px solid #28a745"><h2
                                                class="gform_submission_error hide_summary" id="error_message">Bạn đã
                                            đăng ký thành công, vui lòng check email.</h2></div>
                            </form>
                        </div>
                    </div>
